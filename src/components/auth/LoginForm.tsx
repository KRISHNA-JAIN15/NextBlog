    ...
    <Card className="max-w-md mx-auto shadow-card" hover>
      ...
      <CardContent>
        ...
        <div className="grid grid-cols-2 gap-3">
          <button className="flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-dark-200 border border-dark-100 text-neutral-300 hover:border-primary-500/30 hover:bg-primary-500/5 transition-all">
