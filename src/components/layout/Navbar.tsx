    ...
    <nav className="bg-white shadow-sm border-b border-neutral-200">
        ...
        <div className="flex justify-between h-16">
          <div className="flex items-center">
            <Link href="/" className="flex-shrink-0 flex items-center">
              <span className="text-2xl font-bold text-primary-600">NextBlog</span>
            </Link>
            <div className="hidden sm:ml-6 sm:flex sm:space-x-8">
              ...
              <Link
                href="/blogs"
                className={`inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium ${pathname?.startsWith('/blogs')
                    ? 'border-primary-500 text-neutral-900'
                    : 'border-transparent text-neutral-500 hover:text-neutral-700 hover:border-neutral-300'
                  }`}
              >
      ...
      <div className={`${isMenuOpen ? 'block' : 'hidden'} sm:hidden`}>
        <div className="pt-2 pb-3 space-y-1">
          ...
          <Link
            href="/blogs"
            className={`block pl-3 pr-4 py-2 border-l-4 text-base font-medium ${pathname?.startsWith('/blogs')
                ? 'border-primary-500 text-primary-700 bg-primary-50'
                : 'border-transparent text-neutral-600 hover:bg-neutral-50 hover:border-neutral-300 hover:text-neutral-800'
              }`}
          >
        ...
        <div className="pt-4 pb-3 border-t border-neutral-200">
          {user ? (
            ...
            <div className="space-y-3 px-4">
              ...
              <Link
                href="/signup"
                className="block px-4 py-2 text-base font-medium text-primary-600 hover:text-primary-800 hover:bg-neutral-100"
              >
                Sign Up
              </Link>
            </div>
